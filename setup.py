...
setup(
  ...
  download_url = 'https://github.com/elydev01/mcolorpicker/archive/pypi-0_1.tar.gz',
  keywords = ['kivy', 'color', 'picker', 'kivymd', 'choose', 'mobile'],
  install_requires=[
          'kivy',
          'kivymd',
      ],
  classifiers=[
    ...
    'Topic :: Software Development :: Build Tools :: Mobile Development',
